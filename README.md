...
1. Install python (https://www.python.org/downloads/) and git (https://git-scm.com/install/).
2. In order to setup an environment for using this project open terminal of your choice (e.g. previously installed git) and type the following commands.<br>
`git clone https://github.com/jakubkosno/IBJJFDQ.git`<br>
`cd IBJJFDQ`<br>
